...
A personal portfolio website built with Flask, featuring user authentication, a guestbook commenting system, and deployment to my local kubernetes via GitHub Actions.
